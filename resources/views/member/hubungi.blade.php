            ...
            <div class="mt-3">
                <div class="row">
                    <div class="col-lg-6 col-md-6">
                        <p class="font-weight-bold">Bengkel Oke Surakarta</p>
                        <p>Hubungi Kami Lewat Whatsapp : <a href="https://wa.me/6281227827967?text=Hai, Bengkel Oke Saya Ingin Bertanya...." target="_blank">+6281227827967</a></p>
                    </div>
                    <div class="col-lg-6 col-md-6">
